...
public class ThongKeThuoc extends JPanel {
    ...
    private void initComponents() {
        ...
        cb_LoaiThuoc = new JComboBox<>();
        btn_ThuocHetHan = new JButton();
        ...
        btn_Search.setIcon(new ImageIcon("src/main/java/img/nhanvien/circle.png"));
        ...
        cb_LoaiThuoc.setModel(new DefaultComboBoxModel<>(new String[] { "Chọn loại thuốc" }));
        ...
        jButton2.setIcon(new ImageIcon(getClass().getResource("/img/nhanvien/refresh.png"))); // NOI18N
        ...
        jButton4.setIcon(new ImageIcon(getClass().getResource("/img/nhanvien/logo.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(btn_ThuocHetHan, GroupLayout.PREFERRED_SIZE, 170, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
            ...
            .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jMonthChooser1, GroupLayout.DEFAULT_SIZE, 164, Short.MAX_VALUE)
                    .addGap(18, 18, 18)
                    .addComponent(tf_Search, GroupLayout.PREFERRED_SIZE, 152, GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                    .addComponent(btn_Search))
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGap(6, 6, 6)
                    .addComponent(cb_LoaiThuoc, GroupLayout.PREFERRED_SIZE, 154, GroupLayout.PREFERRED_SIZE)
                    .addGap(18, 18, 18)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(29, 29, 29)
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cb_LoaiThuoc, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_ThuocHetHan, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)))
        );
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(jScrollPane2, GroupLayout.DEFAULT_SIZE, 433, Short.MAX_VALUE)
                .addGap(8, 8, 8))
        );

        jPanel2.setBorder(BorderFactory.createTitledBorder(null, "Thông tin", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14))); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(card2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(card1, GroupLayout.PREFERRED_SIZE, 114, GroupLayout.PREFERRED_SIZE))
    ...
    private void setupSearch() {
        tf_Search.setText("Tìm kiếm thuốc"); // Placeholder
        ...
        tf_Search.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (tf_Search.getText().trim().isEmpty()) {
                    tf_Search.setText("Tìm kiếm thuốc");
                }
            }
        });
        ...
        Timer searchTimer = new Timer(300, e -> {
            try {
                ...
                Logger.getLogger(ThongKeThuoc.class.getName()).log(Level.SEVERE,
                        "Lỗi khi tìm kiếm thời gian thực: " + ex.getMessage(), ex);
            }
        });
        searchTimer.setRepeats(false); // Chỉ chạy một lần sau khi ngừng gõ
    ...
    public void search() throws RemoteException {
        ...
        String selectedLoaiThuoc = cb_LoaiThuoc.getSelectedItem() != null ? cb_LoaiThuoc.getSelectedItem().toString() : null;

        // Kiểm tra từ khóa tìm kiếm
        if (query.isEmpty() || query.equals("Tìm kiếm thuốc")) {
            resetTable();
            loadDataTable(); // Tải lại toàn bộ dữ liệu
            return;
        }

        // Chỉ tìm kiếm nếu từ khóa dài hơn 2 ký tự để tối ưu
        if (query.length() < 2) {
            resetTable();
            loadDataTable();
            return;
        ...
        try {
            ...
            // Tìm kiếm thuốc theo từ khóa và loại thuốc (nếu có)
            list_Thuoc = thuoc_dao.searchThuoc(query);
            ...
            if (list_Thuoc != null && !list_Thuoc.isEmpty()) {
                ...
                Notifications.getInstance().show(Notifications.Type.INFO,
                        "Không tìm thấy thuốc với từ khóa: " + query);
            }
        } catch (RemoteException e) {
            Logger.getLogger(ThongKeThuoc.class.getName()).log(Level.SEVERE,
                    "Lỗi khi tìm kiếm thuốc: " + e.getMessage(), e);
            Notifications.getInstance().show(Notifications.Type.ERROR,
                    "Lỗi hệ thống khi tìm kiếm thuốc");
            resetTable();
        }
    }
    private void performRealTimeSearch() throws RemoteException {
        ...
        if (query.length() < 2 || query.equals("Tìm kiếm thuốc")) {
            resetTable();
            loadDataTable();
            return;
        }

        search(); // Gọi hàm search để xử lý
    }
    ...
    private JButton btn_ThuocHetHan;
    private card.Card card1;
    private card.Card card2;
    private JComboBox<String> cb_LoaiThuoc;
