 ...
 * @author HÀ NHƯ
 */
public class DoiTra_GUI extends JPanel {
    ...
    private void initComponents() {
        ...
        table_HD = new JTable();
        jPanel3 = new JPanel();
        lbl_MaHDDT = new JLabel();
        txtMaHDDT = new JTextField();
        lbl_MaHD = new JLabel();
        txtMaHD = new JTextField();
        lbl_NgayDT = new JLabel();
        lbl_BangSanPham = new JLabel();
        lbl_TienHoan = new JLabel();
        lbl_LyDo = new JLabel();
        ...
        btn_searchReturnOrder.setIcon(new ImageIcon(getClass().getResource("/img/nhanvien/circle.png"))); // NOI18N
        ...
        btn_barcode.setIcon(new ImageIcon(getClass().getResource("/img/nhanvien/barcode.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txt_MaHD, GroupLayout.PREFERRED_SIZE, 346, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(btn_searchReturnOrder, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(btn_barcode, GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
                .addGap(32, 32, 32))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_MaHD, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE)
                    .addComponent(btn_searchReturnOrder, GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(btn_barcode, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(6, 6, 6))
        );

        jPanel2.setBorder(BorderFactory.createTitledBorder(null, "Thông tin hóa đơn", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 16))); // NOI18N
        ...
        jPanel3.setBorder(BorderFactory.createTitledBorder(null, "Thông tin đổi trả", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 16))); // NOI18N
        ...
        GroupLayout button_groupLayout = new GroupLayout(button_group);
        button_group.setLayout(button_groupLayout);
        button_groupLayout.setHorizontalGroup(
            button_groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        button_groupLayout.setVerticalGroup(
            button_groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(button_groupLayout.createSequentialGroup()
                .addGroup(button_groupLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(rdn_Tra)
                    .addComponent(rdn_Doi))
        ...
        jPanel4.setBorder(BorderFactory.createTitledBorder(null, "Nhân viên", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 16))); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(lbl_MaNV, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtMaNV))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(lbl_TenNV, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(lbl_MaNV, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtMaNV, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(lbl_TenNV, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtTenNV, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE))
    ...
    private void btn_searchReturnOrderActionPerformed(ActionEvent evt) throws Exception {//GEN-FIRST:event_btn_searchReturnOrderActionPerformed
    ...
    private void txt_MaHDActionPerformed(ActionEvent evt) {//GEN-FIRST:event_txt_MaHDActionPerformed

    }//GEN-LAST:event_txt_MaHDActionPerformed

    private void btn_TaoHDDTActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_TaoHDDTActionPerformed
    ...
    private void rdn_TraActionPerformed(ActionEvent evt) {//GEN-FIRST:event_rdn_TraActionPerformed

    }//GEN-LAST:event_rdn_TraActionPerformed


    private void btn_ThemActionPerformed(ActionEvent evt) throws RemoteException {//GEN-FIRST:event_btn_ThemActionPerformed
    ...
    private void txt_MaHDKeyPressed(KeyEvent evt) {//GEN-FIRST:event_txt_MaHDKeyPressed
    ...
    private void createNewReturnOrder(DoiTra newReturnOrder) throws Exception {
        if ((new DoiTra_DAO().create(newReturnOrder))) {
            Notifications.getInstance().show(Notifications.Type.SUCCESS, "Thêm hóa đơn đổi trả thành công");
            new ChiTietDoiTra_DAO().createReturnOrderDetail(newReturnOrder, listDoiTra);
            refesh();
    ...
    private void updateTienTra() throws RemoteException {
        ...
        if (rdn_Doi.isSelected()) {
            ...
            for (int i = 0; i < tblModel_SP.getRowCount(); i++) {
                ...
                Thuoc sanPhamInTable = new Thuoc_DAO().getThuocTheoMa(maThuocInTable);
    ...
    private void btn_XoaTrangActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_XoaTrangActionPerformed
        renderReturnOrderInfor();
    ...
    private void txt_MaHDKeyReleased(KeyEvent evt) {//GEN-FIRST:event_txt_MaHDKeyReleased
...
//            txtMaHD.setText("");
    ...
    private void rdn_DoiActionPerformed(ActionEvent evt) {//GEN-FIRST:event_rdn_DoiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdn_DoiActionPerformed

    private void txt_soTienTraActionPerformed(ActionEvent evt) {//GEN-FIRST:event_txt_soTienTraActionPerformed
    ...
    private JLabel lbl_BangSanPham;
    private JLabel lbl_LoaiDT;
    private JLabel lbl_LyDo;
    private JLabel lbl_MaHD;
    private JLabel lbl_MaHDDT;
    private JLabel lbl_MaNV;
    private JLabel lbl_NgayDT;
    private JLabel lbl_TenNV;
    private JLabel lbl_TienHoan;
    private JRadioButton rdn_Doi;
    private JRadioButton rdn_Tra;
