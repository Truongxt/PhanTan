...
public class KiemTien_GUI extends javax.swing.JPanel {
    ...
    public KiemTien_GUI(TaiKhoan tk) throws RemoteException {
        initComponents();
        initTableModel();
        initForm(nv);
        alterTable();
...
//                        Notifications.getInstance().show(Notifications.Type.ERROR, "Số lượng không hợp lệ!");
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jtf_tongTien, javax.swing.GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        btn_baoCao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/nhanvien/tournament.png"))); // NOI18N
