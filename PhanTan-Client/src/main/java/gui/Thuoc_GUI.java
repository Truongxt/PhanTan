...
public class Thuoc_GUI extends javax.swing.JPanel {
    ...
    private List<LoaiThuoc> listLoaiThuoc;
    private List<XuatXu> listXuatXu;
    private List<DonViTinh> listDonVi;
    private static CellStyle cellStyleFormatNumber = null;

    public Thuoc_GUI() throws Exception {
        initComponents();
    ...
    public void InitJCB() throws Exception {
        listNCC = new NhaCungCap_DAO().getAll();
        listLoaiThuoc = new LoaiThuoc_DAO().getAllLoaiThuoc();
        listXuatXu = new XuatXu_DAO().getAllXuatXu();
        listDonVi = new DonViTinh_DAO().findAll();
        ...
        for (XuatXu xuatXu : listXuatXu) {
            jcb_xuatXu.addItem(xuatXu.getTenXuatXu());
            jcb_locXuatXu.addItem(xuatXu.getTenXuatXu());
        }
    ...
    public Object[] initObject(Thuoc t) throws Exception {
        ...
        obj[0] = t.getMaThuoc();
        obj[1] = t.getTenThuoc();
        obj[2] = new LoaiThuoc_DAO().getLoaiThuoc(t.getMaLoai().getMaLoai()).getTenLoai();
        obj[3] = new XuatXu_DAO().getXuatXuById(t.getMaXuatXu().getMaXuatXu()).getTenXuatXu();
        obj[4] = t.getGia();
        obj[5] = new DonViTinh_DAO().findById(t.getMaDonViTinh().getMaDonViTinh());
    ...
    private void loadThuocActionPerformed(java.awt.event.ActionEvent evt) throws Exception {//GEN-FIRST:event_loadThuocActionPerformed
        model.setRowCount(0);
        initTable();
    ...
    private void tableThuocMouseClicked(java.awt.event.MouseEvent evt) throws Exception {//GEN-FIRST:event_tableThuocMouseClicked
        ...
        jcb_loaiThuoc.setSelectedItem(new LoaiThuoc_DAO().getLoaiThuoc(thuoc.getMaLoai().getMaLoai()).getMaLoai());
        jcb_xuatXu.setSelectedItem(new XuatXu_DAO().getXuatXuById(thuoc.getMaXuatXu().getMaXuatXu()).getMaXuatXu());
        jcb_donVi.setSelectedItem(new DonViTinh_DAO().findById(thuoc.getMaDonViTinh().getMaDonViTinh()).getMaDonViTinh());
        jcb_NCC.setSelectedItem(new NhaCungCap_DAO().getById(thuoc.getMaNCC().getMaNCC()).getMaNCC());
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) throws Exception {//GEN-FIRST:event_btn_themActionPerformed
    ...
    private void jtf_timKiemTheoTenKeyTyped(java.awt.event.KeyEvent evt) throws Exception {//GEN-FIRST:event_jtf_timKiemTheoTenKeyTyped
        model.setRowCount(0);
    ...
    private void jtf_timKiemTheoMaKeyTyped(java.awt.event.KeyEvent evt) throws Exception {//GEN-FIRST:event_jtf_timKiemTheoMaKeyTyped
        model.setRowCount(0);
    ...
    private void btn_locActionPerformed(java.awt.event.ActionEvent evt) throws Exception {//GEN-FIRST:event_btn_locActionPerformed
        model.setRowCount(0);
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) throws Exception {//GEN-FIRST:event_btn_suaActionPerformed
        int index = tableThuoc.getSelectedRow();
        if (index == -1) {
    ...
    public static void refesh() throws SQLException, Exception {
        Main.app.refeshPro();
    }
    ...
    private void writeFooter(SXSSFSheet sheet, int rowIndex) throws RemoteException {
    ...
    private void writeThuoc(Thuoc t, SXSSFRow row) {
        ...
        cell = row.createCell(7);
        cell.setCellValue(t.getMaLoai().getMaLoai());
        cell = row.createCell(8);
        cell.setCellValue(t.getMaXuatXu().getMaXuatXu());
        cell = row.createCell(9);
        cell.setCellValue(t.getMaDonViTinh().getMaDonViTinh());
        cell = row.createCell(10);
        cell.setCellValue(t.getMaNCC().getMaNCC());
