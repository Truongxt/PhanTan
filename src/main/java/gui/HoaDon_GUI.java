...
//ẩn các button không chứa tiền
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 32, 160, 25));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel2.setText("Tên khách hàng : ");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 65, 160, 25));
        ...
        jPanel1.add(jtf_tenKH, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 65, 252, 25));
        ...
        jPanel1.add(jtf_sdt, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 32, 252, 25));
...
//    }
    public Object[] initObject(Thuoc t) throws Exception {
        ...
        obj[4] = new DonViTinh_DAO().findById(t.getMaDonViTinh().getMaDonViTinh()).getTen();
        obj[5] = t.getGia();
        obj[6] = t.getThue();
        return obj;
    }
