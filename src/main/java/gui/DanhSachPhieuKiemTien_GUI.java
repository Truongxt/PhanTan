...
public class DanhSachPhieuKiemTien_GUI extends javax.swing.JPanel {
     ...
     */
    public DanhSachPhieuKiemTien_GUI() throws Exception {
        initComponents();
        initTableModel();
        alterTable();
...
////        Align
    ...
    public void renderCustomerTable(ArrayList<BangKiemTien> list) {
        ...
        for (BangKiemTien bangKiemTien : list) {
            ...
            NhanVien nv1 = bangKiemTien.getListChiTietBangKiemTien().get(0).getMaNhanVien();
            NhanVien nv2 = bangKiemTien.getListChiTietBangKiemTien().get(1).getMaNhanVien();
    ...
    private void initComponents() {
        ...
        tbl_bangKiemTien.setModel(new DefaultTableModel(
            new Object [][] {
    ...
    private void tbl_bangKiemTienMouseClicked(java.awt.event.MouseEvent evt) throws Exception {//GEN-FIRST:event_tbl_bangKiemTienMouseClicked
        // TODO add your handling code here:
