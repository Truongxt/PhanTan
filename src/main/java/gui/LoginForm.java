...
//        ConnectDB.connect();
    ...
    private void btn_DangNhapActionPerformed(ActionEvent evt) throws RemoteException {//GEN-FIRST:event_btn_DangNhapActionPerformed
    ...
    for (TaiKhoan tk : Listtk) {
        if (tk.getTenTaiKhoan().equalsIgnoreCase(username) && tk.getPassword().equals(hashedPassword)) {
            return tk;
        }
    }
    return null;
