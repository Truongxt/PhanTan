...
public class KetToan_GUI extends javax.swing.JPanel {
    ...
    public KetToan_GUI(TaiKhoan tk) throws RemoteException {
        ...
        this.tk = tk;
        nv = new NhanVien_DAO().getNhanVien(tk.getMaNhanVien().getMaNhanVien());
...
//                        Notifications.getInstance().show(Notifications.Type.ERROR, "Số lượng không hợp lệ!");
    ...
    private void initComponents() {
        ...
        tbl_demTien.setModel(new DefaultTableModel(
            new Object [][] {
                {"1", "500.000", null, null},
                {"2", "200.000", null, null},
                {"3", "100.000", null, null},
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jtf_tongTien, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE)
                .addContainerGap())
        ...
        btn_ketToan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/nhanvien/tournament.png"))); // NOI18N
