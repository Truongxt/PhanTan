...
public class DanhSachPhieuKetToan_GUI extends javax.swing.JPanel {
     ...
     */
    public DanhSachPhieuKetToan_GUI() throws Exception {
        initComponents();
        initTableModel();
    ...
    public void renderCustomerTable(ArrayList<KetToan> list) throws Exception {
        model.setRowCount(0);
        for (KetToan ketToan : list) {
            ...
            NhanVien nv1 = ketToan.getBangKiemTien().getListChiTietBangKiemTien().get(0).getMaNhanVien();
            NhanVien nv2 = ketToan.getBangKiemTien().getListChiTietBangKiemTien().get(1).getMaNhanVien();
            Date ngayBatDau = ketToan.getNgayBatDau();
            Date ngayKetThuc = ketToan.getNgayKetThuc();
            ketToan.setHoaDons(new HoaDon_DAO().getAllOrderInAcountingVoucher(id));
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/nhanvien/refresh.png"))); // NOI18N
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 60, 90, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 10, 90, 30));
        ...
        tbl_danhSachPhieuKetToan.setModel(new DefaultTableModel(
            new Object [][] {
    ...
    private void tbl_danhSachPhieuKetToanMouseClicked(java.awt.event.MouseEvent evt) throws Exception {//GEN-FIRST:event_tbl_danhSachPhieuKetToanMouseClicked
        // TODO add your handling code here:
