   ...
   private void init(String message) {
    ...
    try {
        if (type == Type.SUCCESS) {
            setIcon(lbIcon, "/notification/sucess.png");
            lbMessage.setText("Success");
        } else if (type == Type.INFO) {
            setIcon(lbIcon, "/notification/info.png");
            lbMessage.setText("Info");
        } else {
            setIcon(lbIcon, "/notification/warning.png");
            lbMessage.setText("Warning");
        }
        setIcon(cmdClose, "/notification/close.png");
    } catch (Exception ex) {
        ex.printStackTrace();
    }
