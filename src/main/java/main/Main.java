        ...
        menu.addEvent(new EventMenuSelected() {
            ...
            public void menuSelected(int menuIndex, int subMenuIndex) throws Exception {
                if (menuIndex == 0) {
                    ...
                    try {
                        if (tk.getMaVaiTro().getMaVaiTro().equalsIgnoreCase("NVQL1203")) {
                            main.showForm(new Thuoc_GUI());
                        } else {
...
//                    ConnectDB.disconnect();
    ...
    public void initHeaderLabel() throws RemoteException {
        vaiTro = new VaiTro_DAO().getVaiTro(tk.getMaVaiTro().getMaVaiTro());
        nhanVien = new NhanVien_DAO().getNhanVien(tk.getMaNhanVien().getMaNhanVien());
    }
