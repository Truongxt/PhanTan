...
public class Card extends javax.swing.JPanel {
    ...
    public void setData(ModelCard data) {
        ...
        lbValues.setText(df.format(data.getValues())+"VND");
        lbIcon.setIcon(data.getIcon());
        pro.setValue(data.getPercentage());
        lbPer.setText(df.format(data.getPercentage()) + "%");
    }
    
     public void setDataNormal(ModelCard data) {
        DecimalFormat df = new DecimalFormat("#,##0.##");
        lbTitle.setText(data.getTitle());
    ...
    private void initComponents() {
        ...
        lbTitle.setForeground(new Color(225, 225, 225));
        lbTitle.setText("Title");

        lbValues.setFont(new java.awt.Font("sansserif", 0, 24)); // NOI18N
        lbValues.setForeground(new Color(225, 225, 225));
        lbValues.setText("Values");

        lbIcon.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);

        lbPer.setForeground(new Color(255, 255, 255));
        lbPer.setText("0%");
